...
const BURIAL_FONT = '14px "IBM Plex Mono", monospace';
const BURIAL_LINE_H = 26;
...
export class NarrativeController {
  constructor(bus) {
    ...
    this._lines       = [];
    this._speaker     = '';
    this._isBurial    = false;
    this._promptAlpha = 0;
    this._boxAlpha    = 0;    // for fade-in/out
  }
  ...
  goNode(id) {
    ...
    this._isBurial   = node.voice === 'burial';
  ...
  draw(ctx) {
    ...
    const font    = this._isBurial ? BURIAL_FONT : NARRATOR_FONT;
    const lineH   = this._isBurial ? BURIAL_LINE_H : NARRATOR_LINE_H;
    const textCol = this._isBurial ? COL_BURIAL : COL_TEXT;
